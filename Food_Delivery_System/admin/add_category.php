...
if (isset($_POST['submit'])) {
    if (empty($_POST['c_name'])) {
        ...
        $check_cat = mysqli_query($db, "SELECT c_name FROM restaraunt_category where c_name = '" . $_POST['c_name'] . "' ");
        ...
        if (mysqli_num_rows($check_cat) > 0) {
            ...
            $mql = "INSERT INTO restaraunt_category(c_name) VALUES('" . $_POST['c_name'] . "')";
            mysqli_query($db, $mql);
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM restaraunt_category order by category_id desc";
