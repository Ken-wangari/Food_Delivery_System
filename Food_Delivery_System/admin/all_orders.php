                    ...
                    <div class="col-12">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                ...
                                <div> <a href="generate_report.php" class=" float-right">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.user_id=users_orders.user_id ";
                                            ...
                                            <?php
                                                    ...
                                                    ?>
                                            <td>
                                                <a href="delete_orders.php?order_del=<?php echo $rows['order_id']; ?>"
