...
if (strlen($_SESSION['user_id']) == 0) {
  ...
  if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($db, "insert into feedback(frm_id,status,feedback) values('$form_id','$status','$feedback')");
    $sql = mysqli_query($db, "update users_orders set status='$status' where order_id='$form_id'");
    ...
    <div style="margin-left:50px;">
      <form name="updateticket" id="updatecomplaint" method="post">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          $ret1 = mysqli_query($db, "select * FROM users_orders where order_id='" . $_GET['newform_id'] . "'");
