                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.user_id=users_orders.user_id where order_id='" . $_GET['user_upd'] . "'";
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['order_id']); ?>');"
                                                            title="Update order">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['order_id']); ?>');"
                                                            title="Update order">
                                                            <button type="button" class="btn btn-primary">Go to User
                                                                Profile</button></a>
