...
<body>
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a
                            href="meals.php?restaraunt_id=<?php echo $_GET['restaraunt_id']; ?>">Pick Your favorite
                            food</a></li>
        ...
        <?php $ress = mysqli_query($db, "select * from restaurant where restaraunt_id='$_GET[restaraunt_id]'");
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                            <div class="image-wrap">
                                <figure>
                                    <?php echo '<img src="admin/restaraunt_image/' . $rows['image'] . '" alt="Restaurant logo">'; ?>
                                </figure>
                            </div>
                        </div>
        ...
        <div class="container m-t-30">
            <div class="row">
                    ...
                    <div class="widget widget-cart">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="title-row">
                                    <?php echo $item["title"]; ?><a
                                        href="meals.php?restaraunt_id=<?php echo $_GET['restaraunt_id']; ?>&action=remove&id=<?php echo $item["dish_id"]; ?>">
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0"
                                            value=<?php echo "Ksh" . $item["price"]; ?> readonly id="exampleSelect1">
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="checkout.php?restaraunt_id=<?php echo $_GET['restaraunt_id']; ?>&action=check"
                ...
                <div class="col-md-8">
                    ...
                    <div class="menu-widget" id="2">
                        ...
                        <div class="collapse in" id="popular2">
                            <?php
                            $stmt = $db->prepare("select * from meals where restaraunt_id='$_GET[restaraunt_id]'");
                            $stmt->execute();
                            ...
                            <div class="food-item">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post"
                                            action='meals.php?restaraunt_id=<?php echo $_GET['restaraunt_id']; ?>&action=add&id=<?php echo $product['dish_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left"
                                                    href="#"><?php echo '<img src="admin/restaraunt_image/meals/' . $product['img'] . '" alt="Food logo">'; ?></a>
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        ...
                                        <input class="b-r-0" type="number" name="quantity" style="margin-left:30px;"
                                            value=1 size="2" required min="1" />
                ...
                <a href="index.php" class="btn btn-success btn-lg active">Search for more meals</a>
            </div>
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Ksh
                                    2.99</span></div>
