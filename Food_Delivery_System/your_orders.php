                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="bg-gray">
                                <div class="row">
                                    <a href="generate_report.php" class="btn btn-primary"><i
                                            class="fa fa-download"></i>Download Order Report</a>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $query_res = mysqli_query($db, "select * from users_orders where user_id='" . $_SESSION['user_id'] . "'");
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td data-column="Action"> <a
                                                                href="delete_orders.php?order_del=<?php echo $row['order_id']; ?>"
